...
if (isset($_POST['name']) AND isset($_POST['password'])) {
	...
	$user = $_POST['name'];
	$user_exist = false;
	foreach($BaseDeDonnees->query("SELECT password FROM deleguer WHERE name = '$user'") as $row) {
		$user_exist = true;
...
<html>
<head>
	<title>Deleguer</title>
</head>
<body>
	<link rel="stylesheet" type="text/css" href="deleguerco.css">
	<meta charset="utf-8">
